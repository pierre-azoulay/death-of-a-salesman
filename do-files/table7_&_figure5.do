...
esttab *, rename(ln_nb_coauthors_nt ln_nb_coauthors) keep(treat log_cites log_pubs log_funding nas ln_nb_trainees ln_nb_coauthors top_prmtr1_setnb female sudden_death) varwidth(25) nonumber noobs nogaps nodep label b(%5.3f) se(%5.3f) star(† 0.10 * 0.05 ** 0.01) compress scalars("N Nb. of Scientists" "r2_p Pseudo-R2") sfmt(%10.0fc %9.3f) mlabels("(0)" "(1)" "(2)" "(3)" "(4)" "(5)" "(6)" "(7)" "(8)") eqlabels(none);
esttab * using "${F10}tables/table_7.rtf", rename(ln_nb_coauthors_nt ln_nb_coauthors) keep(treat log_cites log_pubs log_funding nas ln_nb_trainees ln_nb_coauthors top_prmtr1_setnb female sudden_death) varwidth(25) nonumber noobs nogaps nodep label b(%5.3f) se(%5.3f) star(† 0.10 * 0.05 ** 0.01) compress scalars("N Nb. of Scientists" "r2_p Pseudo-R2") sfmt(%10.0fc %9.3f) mlabels("(0)" "(1)" "(2)" "(3)" "(4)" "(5)" "(6)" "(7)" "(8)") eqlabels(none) replace;
